...
from controllers.vw_schedules_controller import get_tbl_info, get_a_row

vw_schedules_bp = Blueprint('vw_schedules_bp', __name__, url_prefix='/vw_schedules') #adds this first before routes.

#Load/Get Routes

@vw_schedules_bp.route('/get_tbl_info', methods=['GET'])
...
@vw_schedules_bp.route('/get_a_column', methods=['GET'])
def route_get_a_row():
    req_table_name = request.args.get('table_name')
