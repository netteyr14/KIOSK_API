...
from controllers.vw_announcements_controller import get_tbl_info, get_a_row

vw_announcements_bp = Blueprint('vw_announcements_bp', __name__, url_prefix='/vw_announcements') #adds this first before routes.

#Load/Get Routes

@vw_announcements_bp.route('/get_tbl_info', methods=['GET'])
...
@vw_announcements_bp.route('/get_a_column', methods=['GET'])
def route_get_a_row():
    req_table_name = request.args.get('table_name')
