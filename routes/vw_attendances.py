...
from controllers.vw_attendances_contrller import get_tbl_info, get_a_row

vw_attendances_bp = Blueprint('vw_attendances_bp', __name__, url_prefix='/vw_attendances') #adds this first before routes.

#Load/Get Routes

@vw_attendances_bp.route('/get_tbl_info', methods=['GET'])
...
@vw_attendances_bp.route('/get_a_column', methods=['GET'])
def route_get_a_row():
    req_table_name = request.args.get('table_name')
